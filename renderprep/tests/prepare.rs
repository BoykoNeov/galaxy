...
fn sample_state() -> State {
    State {
        ...
        u: vec![0.0; 3],
        formation_time: vec![State::PRIMORDIAL; 3],
        time: 5.0,
        a: 1.0,
    }
}
...
fn density_tiny_state_does_not_panic() {
    ...
    let state = State {
        ...
        u: vec![0.0; 2],
        formation_time: vec![State::PRIMORDIAL; 2],
        time: 0.0,
        a: 1.0,
    };
    let cfg = PrepConfig {
...
fn two_temperature_state() -> State {
    ...
    State {
        ...
        u: vec![0.0; 6],
        formation_time: vec![State::PRIMORDIAL; 6],
        time: 0.0,
        a: 1.0,
        pos,
        vel,
...
fn compression_hue_shifts_only_the_compressed_clump() {
    ...
    let state_at = |pos: Vec<DVec3>| State {
        ...
        u: vec![0.0; 8],
        formation_time: vec![State::PRIMORDIAL; 8],
        time: 0.0,
        a: 1.0,
        pos,
    };
...
fn mixed_species_state() -> State {
    State {
        ...
        u: vec![0.0; 5],
        formation_time: vec![State::PRIMORDIAL; 5],
        time: 5.0,
        a: 1.0,
    }
}
